 ...
 */
final class Version20190517192244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD image_name VARCHAR(255) DEFAULT NULL, CHANGE likes likes INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP image_name, CHANGE likes likes INT DEFAULT NULL');
